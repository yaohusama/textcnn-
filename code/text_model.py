...
class TextConfig():
    ...
    num_classes=2         #number of labels10
    ...
    train_filename='./data/waimai.train.txt'  #train data
    test_filename='./data/waimai.test.txt'    #test data
    val_filename='./data/waimai.val.txt'      #validation data
